...
<div class="container d-flex d-center">
    <div class="row my-3">
        <div class="col-lg-8">
            <div class="card">
                <img src="https://source.unsplash.com/1200x400?face" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">{{ $pasien->name_pasien }}</p>
                  <p class="card-text">{{ $pasien->alamat_pasien }}</p>
                  <p class="card-text">{{ $pasien->no_telp_pasien }}</p>
                  <p class="card-text">{{ $pasien->jenis_kelamin_pasien }}</p>
                </div>
              </div>
